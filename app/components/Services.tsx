...
const services: Service[] = [
  {
    ...
    tag: "Military-grade build",
    title: "High-Density Nylon Dog Collar",
    desc: "Built with high-density nylon webbing for exceptional durability in tough outdoor conditions.",
    accent: "#b5651d",
    lightAccent: "#fdf3e7",
    delay: "delay-0",
  },
  {
    ...
    tag: "Extreme strength",
    title: "Heavy-Duty Metal Hardware Dog Collar",
    desc: "Engineered with premium aluminium and stainless steel hardware for extreme strength and reliability.",
    accent: "#5a7a3a",
    lightAccent: "#f2f8ec",
    delay: "delay-100",
  },
  {
    ...
    tag: "All-day comfort",
    title: "Breathable Mesh Comfort Dog Collar",
    desc: "Designed with soft padded mesh lining to prevent chafing and ensure comfort during extended wear.",
    accent: "#EC4899",
    lightAccent: "#fce7f3",
    delay: "delay-200",
  },
  {
    ...
    tag: "Tactical ready",
    title: "MOLLE Tactical Dog Collar",
    desc: "Features MOLLE webbing for attaching gear like pouches, ID holders, or GPS trackers.",
    accent: "#2e6da4",
    lightAccent: "#edf4fb",
    delay: "delay-300",
  },
  {
    ...
    tag: "Enhanced control",
    title: "Reinforced Handle Control Dog Collar",
    desc: "Includes a built-in reinforced handle for immediate restraint and better control in active situations.",
    accent: "#06B6D4",
    lightAccent: "#cffafe",
    delay: "delay-400",
  },
  {
    ...
    tag: "Night safety",
    title: "Reflective Safety Dog Collar",
    desc: "Reflective stitching and patch panels improve visibility and identification in low-light conditions.",
    accent: "#F59E0B",
    lightAccent: "#fef3c7",
    delay: "delay-500",
  },
